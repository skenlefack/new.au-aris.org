...
const FALLBACK_DOMAINS: PublicDomain[] = [
  { code: 'governance', name: { en: 'Governance', fr: 'Gouvernance', pt: 'Governança' }, icon: 'Building2', color: '#6B21A8', description: { en: 'Legal frameworks, veterinary services evaluation, and institutional capacity building.', fr: 'Cadres juridiques, évaluation des services vétérinaires et renforcement des capacités institutionnelles.', pt: 'Quadros legais, avaliação de serviços veterinários e capacitação institucional.' } },

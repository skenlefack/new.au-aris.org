  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">{t('rangelandsTitle')}</h1>
          <p className="mt-1 text-sm text-gray-500">
            {t('rangelandsSubtitle')}
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <option value="none">{t('degradNone')}</option>
            <option value="low">{t('degradLow')}</option>
            <option value="moderate">{t('degradModerate')}</option>
            <option value="severe">{t('degradSevere')}</option>
          </select>
        </div>
      </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100 bg-gray-50">
                  ...
                  <th className="px-4 py-3 text-center font-medium text-gray-500">{t('colYear')}</th>
                  <th className="px-4 py-3 text-right font-medium text-gray-500">{t('colNdvi')}</th>
                  <th className="px-4 py-3 text-right font-medium text-gray-500">{t('colBiomass')}</th>
                  <th className="px-4 py-3 text-center font-medium text-gray-500">{t('colDegradation')}</th>
                  <th className="px-4 py-3 text-right font-medium text-gray-500">{t('colCarryingCap')}</th>

...
export const COUNTRIES: Record<string, CountryConfig> = {
  ...
  DZ: { code: 'DZ', name: 'Algeria', nameFr: 'Algérie', namePt: 'Argélia', capital: 'Algiers', flag: '\ud83c\udde9\ud83c\uddff', population: 45.6, languages: ['Arabic', 'Berber', 'French'], timezone: 'Africa/Algiers', recs: ['uma', 'censad'], tenantId: '00000000-0000-4000-a000-000000000601' },
  LY: { code: 'LY', name: 'Libya', nameFr: 'Libye', namePt: 'Líbia', capital: 'Tripoli', flag: '\ud83c\uddf1\ud83c\uddfe', population: 7.0, languages: ['Arabic'], timezone: 'Africa/Tripoli', recs: ['uma', 'censad', 'comesa'], tenantId: '00000000-0000-4000-a000-000000000602' },
  MR: { code: 'MR', name: 'Mauritania', nameFr: 'Mauritanie', namePt: 'Mauritânia', capital: 'Nouakchott', flag: '\ud83c\uddf2\ud83c\uddf7', population: 4.9, languages: ['Arabic', 'French'], timezone: 'Africa/Nouakchott', recs: ['uma', 'censad'], tenantId: '00000000-0000-4000-a000-000000000603' },
  MA: { code: 'MA', name: 'Morocco', nameFr: 'Maroc', namePt: 'Marrocos', capital: 'Rabat', flag: '\ud83c\uddf2\ud83c\udde6', population: 37.8, languages: ['Arabic', 'Berber', 'French'], timezone: 'Africa/Casablanca', recs: ['uma', 'censad'], tenantId: '00000000-0000-4000-a000-000000000604' },
  TN: { code: 'TN', name: 'Tunisia', nameFr: 'Tunisie', namePt: 'Tunísia', capital: 'Tunis', flag: '\ud83c\uddf9\ud83c\uddf3', population: 12.0, languages: ['Arabic', 'French'], timezone: 'Africa/Tunis', recs: ['uma', 'censad', 'comesa'], tenantId: '00000000-0000-4000-a000-000000000605' },

  // ── West Africa (ECOWAS) ──
  BJ: { code: 'BJ', name: 'Benin', nameFr: 'Bénin', namePt: 'Benim', capital: 'Porto-Novo', flag: '\ud83c\udde7\ud83c\uddef', population: 13.4, languages: ['French'], timezone: 'Africa/Porto-Novo', recs: ['ecowas', 'censad'], tenantId: '00000000-0000-4000-a000-000000000203' },
  BF: { code: 'BF', name: 'Burkina Faso', nameFr: 'Burkina Faso', namePt: 'Burquina Faso', capital: 'Ouagadougou', flag: '\ud83c\udde7\ud83c\uddeb', population: 22.7, languages: ['French'], timezone: 'Africa/Ouagadougou', recs: ['censad'], tenantId: '00000000-0000-4000-a000-000000000204' },
  CV: { code: 'CV', name: 'Cabo Verde', nameFr: 'Cap-Vert', namePt: 'Cabo Verde', capital: 'Praia', flag: '\ud83c\udde8\ud83c\uddfb', population: 0.6, languages: ['Portuguese'], timezone: 'Atlantic/Cape_Verde', recs: ['ecowas'], tenantId: '00000000-0000-4000-a000-000000000205' },
  CI: { code: 'CI', name: "Côte d'Ivoire", nameFr: "Côte d'Ivoire", namePt: 'Costa do Marfim', capital: 'Yamoussoukro', flag: '\ud83c\udde8\ud83c\uddee', population: 28.2, languages: ['French'], timezone: 'Africa/Abidjan', recs: ['ecowas', 'censad'], tenantId: '00000000-0000-4000-a000-000000000206' },
  GM: { code: 'GM', name: 'Gambia', nameFr: 'Gambie', namePt: 'Gâmbia', capital: 'Banjul', flag: '\ud83c\uddec\ud83c\uddf2', population: 2.7, languages: ['English'], timezone: 'Africa/Banjul', recs: ['ecowas', 'censad'], tenantId: '00000000-0000-4000-a000-000000000207' },
  GH: { code: 'GH', name: 'Ghana', nameFr: 'Ghana', namePt: 'Gana', capital: 'Accra', flag: '\ud83c\uddec\ud83c\udded', population: 33.5, languages: ['English'], timezone: 'Africa/Accra', recs: ['ecowas', 'censad'], tenantId: '00000000-0000-4000-a000-000000000208' },
  GN: { code: 'GN', name: 'Guinea', nameFr: 'Guinée', namePt: 'Guiné', capital: 'Conakry', flag: '\ud83c\uddec\ud83c\uddf3', population: 14.2, languages: ['French'], timezone: 'Africa/Conakry', recs: ['ecowas', 'censad'], tenantId: '00000000-0000-4000-a000-000000000209' },
  GW: { code: 'GW', name: 'Guinea-Bissau', nameFr: 'Guinée-Bissau', namePt: 'Guiné-Bissau', capital: 'Bissau', flag: '\ud83c\uddec\ud83c\uddfc', population: 2.1, languages: ['Portuguese'], timezone: 'Africa/Bissau', recs: ['ecowas', 'censad'], tenantId: '00000000-0000-4000-a000-00000000020a' },
  LR: { code: 'LR', name: 'Liberia', nameFr: 'Libéria', namePt: 'Libéria', capital: 'Monrovia', flag: '\ud83c\uddf1\ud83c\uddf7', population: 5.4, languages: ['English'], timezone: 'Africa/Monrovia', recs: ['ecowas', 'censad'], tenantId: '00000000-0000-4000-a000-00000000020b' },
  ML: { code: 'ML', name: 'Mali', nameFr: 'Mali', namePt: 'Mali', capital: 'Bamako', flag: '\ud83c\uddf2\ud83c\uddf1', population: 22.4, languages: ['French'], timezone: 'Africa/Bamako', recs: ['censad'], tenantId: '00000000-0000-4000-a000-00000000020c' },
  NE: { code: 'NE', name: 'Niger', nameFr: 'Niger', namePt: 'Níger', capital: 'Niamey', flag: '\ud83c\uddf3\ud83c\uddea', population: 26.2, languages: ['French'], timezone: 'Africa/Niamey', recs: ['censad'], tenantId: '00000000-0000-4000-a000-00000000020d' },
  ...
  SL: { code: 'SL', name: 'Sierra Leone', nameFr: 'Sierra Leone', namePt: 'Serra Leoa', capital: 'Freetown', flag: '\ud83c\uddf8\ud83c\uddf1', population: 8.6, languages: ['English'], timezone: 'Africa/Freetown', recs: ['ecowas', 'censad'], tenantId: '00000000-0000-4000-a000-00000000020e' },
  TG: { code: 'TG', name: 'Togo', nameFr: 'Togo', namePt: 'Togo', capital: 'Lomé', flag: '\ud83c\uddf9\ud83c\uddec', population: 8.8, languages: ['French'], timezone: 'Africa/Lome', recs: ['ecowas', 'censad'], tenantId: '00000000-0000-4000-a000-00000000020f' },

  // ── Central Africa (ECCAS) ──
  AO: { code: 'AO', name: 'Angola', nameFr: 'Angola', namePt: 'Angola', capital: 'Luanda', flag: '\ud83c\udde6\ud83c\uddf4', population: 35.6, languages: ['Portuguese'], timezone: 'Africa/Luanda', recs: ['eccas', 'sadc'], tenantId: '00000000-0000-4000-a000-000000000501' },
  BI: { code: 'BI', name: 'Burundi', nameFr: 'Burundi', namePt: 'Burundi', capital: 'Gitega', flag: '\ud83c\udde7\ud83c\uddee', population: 13.2, languages: ['Kirundi', 'French', 'English'], timezone: 'Africa/Bujumbura', recs: ['eccas', 'eac', 'comesa'], tenantId: '00000000-0000-4000-a000-000000000502' },
  CM: { code: 'CM', name: 'Cameroon', nameFr: 'Cameroun', namePt: 'Camarões', capital: 'Yaoundé', flag: '\ud83c\udde8\ud83c\uddf2', population: 28.6, languages: ['French', 'English'], timezone: 'Africa/Douala', recs: ['eccas', 'censad'], tenantId: '00000000-0000-4000-a000-000000000503' },
  CF: { code: 'CF', name: 'Central African Republic', nameFr: 'République centrafricaine', namePt: 'República Centro-Africana', capital: 'Bangui', flag: '\ud83c\udde8\ud83c\uddeb', population: 5.5, languages: ['French', 'Sango'], timezone: 'Africa/Bangui', recs: ['eccas', 'censad'], tenantId: '00000000-0000-4000-a000-000000000504' },
  TD: { code: 'TD', name: 'Chad', nameFr: 'Tchad', namePt: 'Chade', capital: "N'Djamena", flag: '\ud83c\uddf9\ud83c\udde9', population: 18.3, languages: ['French', 'Arabic'], timezone: 'Africa/Ndjamena', recs: ['eccas', 'censad'], tenantId: '00000000-0000-4000-a000-000000000505' },
  CG: { code: 'CG', name: 'Congo', nameFr: 'Congo', namePt: 'Congo', capital: 'Brazzaville', flag: '\ud83c\udde8\ud83c\uddec', population: 6.1, languages: ['French'], timezone: 'Africa/Brazzaville', recs: ['eccas'], tenantId: '00000000-0000-4000-a000-000000000506' },
  CD: { code: 'CD', name: 'DR Congo', nameFr: 'RD Congo', namePt: 'RD Congo', capital: 'Kinshasa', flag: '\ud83c\udde8\ud83c\udde9', population: 102.3, languages: ['French'], timezone: 'Africa/Kinshasa', recs: ['eccas', 'eac', 'sadc', 'comesa'], tenantId: '00000000-0000-4000-a000-000000000507' },
  GQ: { code: 'GQ', name: 'Equatorial Guinea', nameFr: 'Guinée équatoriale', namePt: 'Guiné Equatorial', capital: 'Malabo', flag: '\ud83c\uddec\ud83c\uddf6', population: 1.7, languages: ['Spanish', 'French', 'Portuguese'], timezone: 'Africa/Malabo', recs: ['eccas'], tenantId: '00000000-0000-4000-a000-000000000508' },
  GA: { code: 'GA', name: 'Gabon', nameFr: 'Gabon', namePt: 'Gabão', capital: 'Libreville', flag: '\ud83c\uddec\ud83c\udde6', population: 2.4, languages: ['French'], timezone: 'Africa/Libreville', recs: ['eccas'], tenantId: '00000000-0000-4000-a000-000000000509' },
  RW: { code: 'RW', name: 'Rwanda', nameFr: 'Rwanda', namePt: 'Ruanda', capital: 'Kigali', flag: '\ud83c\uddf7\ud83c\uddfc', population: 14.1, languages: ['Kinyarwanda', 'French', 'English'], timezone: 'Africa/Kigali', recs: ['eccas', 'eac', 'comesa'], tenantId: '00000000-0000-4000-a000-00000000050a' },
  ST: { code: 'ST', name: 'São Tomé and Príncipe', nameFr: 'Sao Tomé-et-Príncipe', namePt: 'São Tomé e Príncipe', capital: 'São Tomé', flag: '\ud83c\uddf8\ud83c\uddf9', population: 0.2, languages: ['Portuguese'], timezone: 'Africa/Sao_Tome', recs: ['eccas', 'censad'], tenantId: '00000000-0000-4000-a000-00000000050b' },

  // ── East Africa (EAC / IGAD) ──
  DJ: { code: 'DJ', name: 'Djibouti', nameFr: 'Djibouti', namePt: 'Djibuti', capital: 'Djibouti', flag: '\ud83c\udde9\ud83c\uddef', population: 1.1, languages: ['French', 'Arabic'], timezone: 'Africa/Djibouti', recs: ['igad', 'comesa', 'censad'], tenantId: '00000000-0000-4000-a000-000000000105' },
  ER: { code: 'ER', name: 'Eritrea', nameFr: 'Érythrée', namePt: 'Eritreia', capital: 'Asmara', flag: '\ud83c\uddea\ud83c\uddf7', population: 3.7, languages: ['Tigrinya', 'Arabic', 'English'], timezone: 'Africa/Asmara', recs: ['igad', 'comesa', 'censad'], tenantId: '00000000-0000-4000-a000-000000000106' },
  ...
  SO: { code: 'SO', name: 'Somalia', nameFr: 'Somalie', namePt: 'Somália', capital: 'Mogadishu', flag: '\ud83c\uddf8\ud83c\uddf4', population: 18.1, languages: ['Somali', 'Arabic'], timezone: 'Africa/Mogadishu', recs: ['igad', 'comesa', 'censad'], tenantId: '00000000-0000-4000-a000-000000000104' },
  SS: { code: 'SS', name: 'South Sudan', nameFr: 'Soudan du Sud', namePt: 'Sudão do Sul', capital: 'Juba', flag: '\ud83c\uddf8\ud83c\uddf8', population: 11.1, languages: ['English'], timezone: 'Africa/Juba', recs: ['igad', 'eac'], tenantId: '00000000-0000-4000-a000-000000000108' },
  SD: { code: 'SD', name: 'Sudan', nameFr: 'Soudan', namePt: 'Sudão', capital: 'Khartoum', flag: '\ud83c\uddf8\ud83c\udde9', population: 47.9, languages: ['Arabic', 'English'], timezone: 'Africa/Khartoum', recs: ['igad', 'comesa', 'censad'], tenantId: '00000000-0000-4000-a000-000000000107' },
  UG: { code: 'UG', name: 'Uganda', nameFr: 'Ouganda', namePt: 'Uganda', capital: 'Kampala', flag: '\ud83c\uddfa\ud83c\uddec', population: 48.6, languages: ['English', 'Swahili'], timezone: 'Africa/Kampala', recs: ['igad', 'eac', 'comesa'], tenantId: '00000000-0000-4000-a000-000000000103' },
  TZ: { code: 'TZ', name: 'Tanzania', nameFr: 'Tanzanie', namePt: 'Tanzânia', capital: 'Dodoma', flag: '\ud83c\uddf9\ud83c\uddff', population: 65.5, languages: ['Swahili', 'English'], timezone: 'Africa/Dar_es_Salaam', recs: ['eac', 'sadc'], tenantId: '00000000-0000-4000-a000-000000000401' },

  // ── Southern Africa (SADC) ──
  BW: { code: 'BW', name: 'Botswana', nameFr: 'Botswana', namePt: 'Botsuana', capital: 'Gaborone', flag: '\ud83c\udde7\ud83c\uddfc', population: 2.6, languages: ['English', 'Setswana'], timezone: 'Africa/Gaborone', recs: ['sadc'], tenantId: '00000000-0000-4000-a000-000000000302' },
  KM: { code: 'KM', name: 'Comoros', nameFr: 'Comores', namePt: 'Comores', capital: 'Moroni', flag: '\ud83c\uddf0\ud83c\uddf2', population: 0.9, languages: ['Comorian', 'Arabic', 'French'], timezone: 'Indian/Comoro', recs: ['sadc', 'comesa', 'censad'], tenantId: '00000000-0000-4000-a000-000000000303' },
  SZ: { code: 'SZ', name: 'Eswatini', nameFr: 'Eswatini', namePt: 'Essuatíni', capital: 'Mbabane', flag: '\ud83c\uddf8\ud83c\uddff', population: 1.2, languages: ['English', 'Swazi'], timezone: 'Africa/Mbabane', recs: ['sadc', 'comesa'], tenantId: '00000000-0000-4000-a000-000000000304' },
  LS: { code: 'LS', name: 'Lesotho', nameFr: 'Lesotho', namePt: 'Lesoto', capital: 'Maseru', flag: '\ud83c\uddf1\ud83c\uddf8', population: 2.3, languages: ['Sesotho', 'English'], timezone: 'Africa/Maseru', recs: ['sadc'], tenantId: '00000000-0000-4000-a000-000000000305' },
  MG: { code: 'MG', name: 'Madagascar', nameFr: 'Madagascar', namePt: 'Madagáscar', capital: 'Antananarivo', flag: '\ud83c\uddf2\ud83c\uddec', population: 30.3, languages: ['Malagasy', 'French'], timezone: 'Indian/Antananarivo', recs: ['sadc', 'comesa'], tenantId: '00000000-0000-4000-a000-000000000306' },
  MW: { code: 'MW', name: 'Malawi', nameFr: 'Malawi', namePt: 'Maláui', capital: 'Lilongwe', flag: '\ud83c\uddf2\ud83c\uddfc', population: 20.9, languages: ['English', 'Chichewa'], timezone: 'Africa/Blantyre', recs: ['sadc', 'comesa'], tenantId: '00000000-0000-4000-a000-000000000307' },
  MU: { code: 'MU', name: 'Mauritius', nameFr: 'Maurice', namePt: 'Maurícia', capital: 'Port Louis', flag: '\ud83c\uddf2\ud83c\uddfa', population: 1.3, languages: ['English', 'French', 'Creole'], timezone: 'Indian/Mauritius', recs: ['sadc', 'comesa'], tenantId: '00000000-0000-4000-a000-000000000308' },
  MZ: { code: 'MZ', name: 'Mozambique', nameFr: 'Mozambique', namePt: 'Moçambique', capital: 'Maputo', flag: '\ud83c\uddf2\ud83c\uddff', population: 33.9, languages: ['Portuguese'], timezone: 'Africa/Maputo', recs: ['sadc'], tenantId: '00000000-0000-4000-a000-000000000309' },
  NA: { code: 'NA', name: 'Namibia', nameFr: 'Namibie', namePt: 'Namíbia', capital: 'Windhoek', flag: '\ud83c\uddf3\ud83c\udde6', population: 2.6, languages: ['English'], timezone: 'Africa/Windhoek', recs: ['sadc'], tenantId: '00000000-0000-4000-a000-00000000030a' },
  SC: { code: 'SC', name: 'Seychelles', nameFr: 'Seychelles', namePt: 'Seicheles', capital: 'Victoria', flag: '\ud83c\uddf8\ud83c\udde8', population: 0.1, languages: ['Creole', 'English', 'French'], timezone: 'Indian/Mahe', recs: ['sadc', 'comesa'], tenantId: '00000000-0000-4000-a000-00000000030b' },
  ...
  ZM: { code: 'ZM', name: 'Zambia', nameFr: 'Zambie', namePt: 'Zâmbia', capital: 'Lusaka', flag: '\ud83c\uddff\ud83c\uddf2', population: 20.6, languages: ['English'], timezone: 'Africa/Lusaka', recs: ['sadc', 'comesa'], tenantId: '00000000-0000-4000-a000-00000000030c' },
  ZW: { code: 'ZW', name: 'Zimbabwe', nameFr: 'Zimbabwe', namePt: 'Zimbábue', capital: 'Harare', flag: '\ud83c\uddff\ud83c\uddfc', population: 16.7, languages: ['English', 'Shona', 'Ndebele'], timezone: 'Africa/Harare', recs: ['sadc', 'comesa'], tenantId: '00000000-0000-4000-a000-00000000030d' },

  // ── Other ──
  EG: { code: 'EG', name: 'Egypt', nameFr: 'Égypte', namePt: 'Egito', capital: 'Cairo', flag: '\ud83c\uddea\ud83c\uddec', population: 112.7, languages: ['Arabic'], timezone: 'Africa/Cairo', recs: ['comesa', 'censad'], tenantId: '00000000-0000-4000-a000-000000000801' },

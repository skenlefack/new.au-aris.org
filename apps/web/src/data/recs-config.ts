...
export const RECS: Record<string, RecConfig> = {
  ecowas: {
    ...
    description: 'Regional economic union promoting economic integration across West Africa, with 12 member states spanning from Senegal to Nigeria.',
    descriptionFr: 'Union économique régionale favorisant l\u2019intégration économique en Afrique de l\u2019Ouest, avec 12 États membres.',
    descriptionPt: 'União económica regional que promove a integração económica na África Ocidental, com 12 Estados-membros do Senegal à Nigéria.',
    countryCodes: ['BJ', 'CV', 'CI', 'GM', 'GH', 'GN', 'GW', 'LR', 'NG', 'SN', 'SL', 'TG'],
  ...
  censad: {
    ...
    descriptionPt: 'A maior CER em número de membros, ligando a África Saariana e Subsaariana com 29 Estados-membros focados na cooperação económica.',

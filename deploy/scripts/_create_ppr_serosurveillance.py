        ...
        "sections": [
            section("animal_identification",
                ...
                f_text("herd_identifier",
                       L("Herd Identifier", "Identifiant du troupeau",
                         "Identificador do rebanho", "معرف القطيع",
                         "Identificador del rebaño", "Kitambulisho cha Kundi"), 1, col=2),
                f_select_v("species",
                           L("Species", "Espèce",
                             "Espécie", "النوع",
                             "Especie", "Spishi"), 2, [
    ...
    "schema": {
        "sections": [
            section("dispatch_info",
                ...
                f_text("county_team",
                       L("County / Team", "Comté / Équipe",
                         "Condado / Equipa", "المقاطعة / الفريق",
                         "Condado / Equipo", "Kaunti / Timu"), 1, col=2),
    ...
    "schema": {
        "sections": [
            section("sample_identification",
                ...
                f_text("animal_identifier_d",
                       L("Animal Identifier", "Identifiant de l'animal",
                         "Identificador do animal", "معرف الحيوان",
                         "Identificador del animal", "Kitambulisho cha Mnyama"), 1, col=2,
                       helpText=L("Same as B1", "Identique à B1",
                                  "Igual ao B1", "نفس B1",
                                  "Igual que B1", "Sawa na B1")),

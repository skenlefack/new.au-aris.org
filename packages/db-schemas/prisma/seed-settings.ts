...
const SYSTEM_CONFIGS: SystemConfigSeedData[] = [
  ...
  // ── DATA_QUALITY ──
  {
    category: 'DATA_QUALITY', key: 'dataQuality.validation.strictMode',
    value: false,
  ...
  {
    category: 'DATA_QUALITY', key: 'dataQuality.completeness.threshold',
    value: 80,
  ...
  {
    category: 'DATA_QUALITY', key: 'dataQuality.timeliness.deadline',
    value: 30,
  ...
  {
    category: 'DATA_QUALITY', key: 'dataQuality.duplicateDetection.enabled',
    value: true,

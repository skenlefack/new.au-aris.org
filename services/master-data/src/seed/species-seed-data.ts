...
export const SPECIES_SEEDS: SpeciesSeed[] = [
  ...
  { code: 'ORE-NIL', scientificName: 'Oreochromis niloticus', commonNameEn: 'Nile tilapia', commonNameFr: 'Tilapia du Nil', category: 'AQUATIC', productionCategories: ['aquaculture', 'capture'], isWoahListed: true, faoAlphaCode: 'TLN' },
  { code: 'ORE-AUR', scientificName: 'Oreochromis aureus', commonNameEn: 'Blue tilapia', commonNameFr: 'Tilapia bleu', category: 'AQUATIC', productionCategories: ['aquaculture'], isWoahListed: false, faoAlphaCode: 'OEA' },
  { code: 'ORE-MOS', scientificName: 'Oreochromis mossambicus', commonNameEn: 'Mozambique tilapia', commonNameFr: 'Tilapia du Mozambique', category: 'AQUATIC', productionCategories: ['aquaculture'], isWoahListed: false, faoAlphaCode: 'TLM' },
  { code: 'TIL-ZIL', scientificName: 'Tilapia zillii', commonNameEn: 'Redbelly tilapia', commonNameFr: 'Tilapia de Zill', category: 'AQUATIC', productionCategories: ['aquaculture', 'capture'], isWoahListed: false, faoAlphaCode: 'TLZ' },
  { code: 'CLA-GAR', scientificName: 'Clarias gariepinus', commonNameEn: 'African catfish', commonNameFr: 'Poisson-chat africain', category: 'AQUATIC', productionCategories: ['aquaculture', 'capture'], isWoahListed: false, faoAlphaCode: 'CLZ' },
  { code: 'HET-LON', scientificName: 'Heterobranchus longifilis', commonNameEn: 'African catfish (longfin)', commonNameFr: 'Silure africain', category: 'AQUATIC', productionCategories: ['aquaculture'], isWoahListed: false, faoAlphaCode: 'HEL' },
  { code: 'LAT-NIL', scientificName: 'Lates niloticus', commonNameEn: 'Nile perch', commonNameFr: 'Perche du Nil', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'NIP' },
  { code: 'LAB-COU', scientificName: 'Labeo coubie', commonNameEn: 'African carp', commonNameFr: 'Carpe africaine', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'LBU' },
  { code: 'BAG-BAY', scientificName: 'Bagrus bajad', commonNameEn: 'Bayad', commonNameFr: 'Machoiron', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'BGJ' },
  { code: 'GYM-NIL', scientificName: 'Gymnarchus niloticus', commonNameEn: 'Aba aba', commonNameFr: 'Poisson-cheval', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'OGN' },
  { code: 'MOR-RUM', scientificName: 'Mormyrus rume', commonNameEn: 'Mormyrid', commonNameFr: 'Mormyre', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'OMO' },
  { code: 'CYP-CAR', scientificName: 'Cyprinus carpio', commonNameEn: 'Common carp', commonNameFr: 'Carpe commune', category: 'AQUATIC', productionCategories: ['aquaculture'], isWoahListed: false, faoAlphaCode: 'FCP' },
  { code: 'PRO-NIL', scientificName: 'Protopterus annectens', commonNameEn: 'West African lungfish', commonNameFr: 'Protoptère', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'PPG' },
  { code: 'ONC-MYK', scientificName: 'Oncorhynchus mykiss', commonNameEn: 'Rainbow trout', commonNameFr: 'Truite arc-en-ciel', category: 'AQUATIC', productionCategories: ['aquaculture'], isWoahListed: true, faoAlphaCode: 'TRR' },
  { code: 'MUG-CEP', scientificName: 'Mugil cephalus', commonNameEn: 'Flathead grey mullet', commonNameFr: 'Mulet à grosse tête', category: 'AQUATIC', productionCategories: ['capture', 'aquaculture'], isWoahListed: false, faoAlphaCode: 'MUF' },

  // ── Aquatic — Marine fish ──
  { code: 'SAR-PIL', scientificName: 'Sardina pilchardus', commonNameEn: 'European pilchard', commonNameFr: 'Sardine', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'PIL' },
  { code: 'SAR-AUR', scientificName: 'Sardinella aurita', commonNameEn: 'Round sardinella', commonNameFr: 'Sardinelle ronde', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'SAA' },
  { code: 'SAR-MAD', scientificName: 'Sardinella maderensis', commonNameEn: 'Flat sardinella', commonNameFr: 'Sardinelle plate', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'SAE' },
  { code: 'CLU-SPP', scientificName: 'Clupeidae', commonNameEn: 'Clupeids nei', commonNameFr: 'Clupéidés nca', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'CLP' },
  { code: 'THU-ALB', scientificName: 'Thunnus albacares', commonNameEn: 'Yellowfin tuna', commonNameFr: 'Albacore', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'YFT' },
  { code: 'THU-OBE', scientificName: 'Thunnus obesus', commonNameEn: 'Bigeye tuna', commonNameFr: 'Thon obèse', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'BET' },
  { code: 'KAT-PEL', scientificName: 'Katsuwonus pelamis', commonNameEn: 'Skipjack tuna', commonNameFr: 'Bonite à ventre rayé', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'SKJ' },
  { code: 'XIP-GLA', scientificName: 'Xiphias gladius', commonNameEn: 'Swordfish', commonNameFr: 'Espadon', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'SWO' },
  { code: 'SCO-JAP', scientificName: 'Scomber japonicus', commonNameEn: 'Chub mackerel', commonNameFr: 'Maquereau espagnol', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'MAS' },
  { code: 'TRA-TRA', scientificName: 'Trachurus trachurus', commonNameEn: 'Horse mackerel', commonNameFr: 'Chinchard commun', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'HOM' },
  { code: 'MER-MER', scientificName: 'Merluccius merluccius', commonNameEn: 'Hake', commonNameFr: 'Merlu commun', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'HKE' },
  { code: 'DEN-MAC', scientificName: 'Dentex macrophthalmus', commonNameEn: 'Large-eye dentex', commonNameFr: 'Denté à gros yeux', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'DEL' },
  { code: 'PAG-PAG', scientificName: 'Pagellus bellottii', commonNameEn: 'Red pandora', commonNameFr: 'Pageot rouge', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'PAR' },
  { code: 'EPH-AEN', scientificName: 'Epinephelus aeneus', commonNameEn: 'White grouper', commonNameFr: 'Mérou blanc', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'GPW' },
  { code: 'PSE-SEN', scientificName: 'Pseudotolithus senegalensis', commonNameEn: 'Cassava croaker', commonNameFr: 'Otolithe du Sénégal', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'PSS' },
  { code: 'ETH-FIM', scientificName: 'Ethmalosa fimbriata', commonNameEn: 'Bonga shad', commonNameFr: 'Ethmalose', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'BOA' },

  // ── Aquatic — Crustaceans & molluscs ──
  { code: 'PEN-MON', scientificName: 'Penaeus monodon', commonNameEn: 'Giant tiger prawn', commonNameFr: 'Crevette géante tigrée', category: 'AQUATIC', productionCategories: ['aquaculture', 'capture'], isWoahListed: true, faoAlphaCode: 'GIT' },
  { code: 'PEN-VAN', scientificName: 'Litopenaeus vannamei', commonNameEn: 'Whiteleg shrimp', commonNameFr: 'Crevette à pattes blanches', category: 'AQUATIC', productionCategories: ['aquaculture'], isWoahListed: false, faoAlphaCode: 'PNV' },
  { code: 'PEN-SPP', scientificName: 'Penaeus spp.', commonNameEn: 'Penaeid shrimps nei', commonNameFr: 'Crevettes pénéides nca', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'PEN' },
  { code: 'PAN-HOM', scientificName: 'Panulirus homarus', commonNameEn: 'Scalloped spiny lobster', commonNameFr: 'Langouste festonnée', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'LOK' },
  { code: 'CRA-CRA', scientificName: 'Crassostrea gigas', commonNameEn: 'Pacific oyster', commonNameFr: 'Huître creuse', category: 'AQUATIC', productionCategories: ['aquaculture'], isWoahListed: true, faoAlphaCode: 'OYG' },
  { code: 'MYT-GAL', scientificName: 'Mytilus galloprovincialis', commonNameEn: 'Mediterranean mussel', commonNameFr: 'Moule méditerranéenne', category: 'AQUATIC', productionCategories: ['aquaculture'], isWoahListed: false, faoAlphaCode: 'MSM' },
  { code: 'OCT-VUL', scientificName: 'Octopus vulgaris', commonNameEn: 'Common octopus', commonNameFr: 'Poulpe commun', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'OCC' },
  { code: 'SEP-OFF', scientificName: 'Sepia officinalis', commonNameEn: 'Common cuttlefish', commonNameFr: 'Seiche commune', category: 'AQUATIC', productionCategories: ['capture'], isWoahListed: false, faoAlphaCode: 'CTC' },

...
export const SPECIES_SEEDS: SpeciesSeed[] = [
  ...
  { code: 'BUB-BUB', scientificName: 'Bubalus bubalis', commonNameEn: 'Water buffalo', commonNameFr: 'Buffle d\', commonNamePt: 'Búfalo', commonNameAr: 'جاموس'eau', category: 'DOMESTIC', productionCategories: ['milk', 'meat', 'draught'], isWoahListed: true },
  ...
  { code: 'CAV-POR', scientificName: 'Cavia porcellus', commonNameEn: 'Guinea pig', commonNameFr: 'Cochon d\', commonNamePt: 'Porquinho-da-índia', commonNameAr: 'خنزير غينيا'Inde', category: 'DOMESTIC', productionCategories: ['meat'], isWoahListed: false },
  ...
  { code: 'ACH-DOM', scientificName: 'Achatina fulica', commonNameEn: 'Giant African snail', commonNameFr: 'Escargot géant d\', commonNamePt: '', commonNameAr: ''Afrique', category: 'DOMESTIC', productionCategories: ['meat'], isWoahListed: false },
  ...
  { code: 'RHE-AME', scientificName: 'Rhea americana', commonNameEn: 'Greater rhea', commonNameFr: 'Nandou d\', commonNamePt: '', commonNameAr: ''Amérique', category: 'DOMESTIC', productionCategories: ['meat', 'eggs', 'leather'], isWoahListed: false },

  // ── Wildlife — Large mammals ──
  { code: 'SYN-CAF', scientificName: 'Syncerus caffer', commonNameEn: 'African buffalo', commonNameFr: 'Buffle d\', commonNamePt: 'Búfalo-africano', commonNameAr: 'جاموس أفريقي'Afrique', category: 'WILDLIFE', productionCategories: [], isWoahListed: true },
  ...
  { code: 'LOX-AFR', scientificName: 'Loxodonta africana', commonNameEn: 'African elephant', commonNameFr: 'Éléphant d\', commonNamePt: 'Elefante africano', commonNameAr: 'فيل أفريقي'Afrique', category: 'WILDLIFE', productionCategories: [], isWoahListed: false },
  { code: 'LOX-CYC', scientificName: 'Loxodonta cyclotis', commonNameEn: 'African forest elephant', commonNameFr: 'Éléphant de forêt d\', commonNamePt: '', commonNameAr: ''Afrique', category: 'WILDLIFE', productionCategories: [], isWoahListed: false },
  ...
  // ── Wildlife — Primates ──
  { code: 'GOR-GOR', scientificName: 'Gorilla gorilla', commonNameEn: 'Western gorilla', commonNameFr: 'Gorille de l\', commonNamePt: 'Gorila', commonNameAr: 'غوريلا'Ouest', category: 'WILDLIFE', productionCategories: [], isWoahListed: false },
  { code: 'GOR-BER', scientificName: 'Gorilla beringei', commonNameEn: 'Eastern gorilla', commonNameFr: 'Gorille de l\', commonNamePt: '', commonNameAr: ''Est', category: 'WILDLIFE', productionCategories: [], isWoahListed: false },
  ...
  { code: 'CIV-CIV', scientificName: 'Civettictis civetta', commonNameEn: 'African civet', commonNameFr: 'Civette d\', commonNamePt: '', commonNameAr: ''Afrique', category: 'WILDLIFE', productionCategories: ['musk'], isWoahListed: false },
  ...
  { code: 'TRI-MAN', scientificName: 'Trichechus senegalensis', commonNameEn: 'African manatee', commonNameFr: 'Lamantin d\', commonNamePt: '', commonNameAr: ''Afrique', category: 'AQUATIC', productionCategories: [], isWoahListed: false },

...
export const CreateDashboardSchema = Type.Object({
  ...
  titleEs: Type.Optional(Type.String()),
  titleSw: Type.Optional(Type.String()),
...
export const SaveLayoutSchema = Type.Object({
  sections: Type.Array(
    Type.Object({
      ...
      titleEs: Type.Optional(Type.Union([Type.String(), Type.Null()])),
      titleSw: Type.Optional(Type.Union([Type.String(), Type.Null()])),

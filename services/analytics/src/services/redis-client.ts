...
/**
 * Thin wrapper around Redis providing typed operations used by analytics services.
 * Replaces the NestJS RedisService with a plain class taking an ioredis instance.
 */

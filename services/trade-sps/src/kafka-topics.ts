...
export const TOPIC_MS_TRADE_FLOW_DELETED = 'ms.trade.flow.deleted.v1';
...
export const TOPIC_MS_TRADE_SPS_DELETED = 'ms.trade.sps.deleted.v1';
...
export const TOPIC_MS_TRADE_PRICE_DELETED = 'ms.trade.price.deleted.v1';

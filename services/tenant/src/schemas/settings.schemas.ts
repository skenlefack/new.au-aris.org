...
export const UserCreateBodySchema = Type.Object({
  ...
  role: Type.Union([
    ...
    Type.Literal('NATIONAL_LABORATORY'), Type.Literal('REGIONAL_LABORATORY'),
    Type.Literal('CONTINENTAL_LABORATORY'),
  ]),
  tenantId: Type.String({ format: 'uuid' }),
  locale: Type.Optional(Type.String({ maxLength: 5 })),
  accountExpiresAt: Type.Optional(Type.Union([Type.String({ format: 'date-time' }), Type.Null()])),

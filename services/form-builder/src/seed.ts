...
function buildAquacultureFarmRegistration() {
  ...
  const sectionFarm = makeSection(
    ...
    [
      ...
      // Repeater: each production node with its own production system
      makeRepeater('production_nodes',
        { en: 'Production Nodes', fr: 'Nœuds de Production', pt: 'Nós de Produção', ar: 'عقد الإنتاج' },
        [
          { type: 'select', code: 'production_node',
            label: { en: 'Production Node', fr: 'Nœud de Production', pt: 'Nó de Produção', ar: 'عقدة الإنتاج' },
            required: true,
            properties: { options: [
          ...
          { type: 'select', code: 'production_system',
            label: { en: 'Production System', fr: 'Système de Production', pt: 'Sistema de Produção', ar: 'نظام الإنتاج' },
            required: true,
            properties: { options: [
        ...
        { addLabel: { en: 'Add production node', fr: 'Ajouter un nœud de production', pt: 'Adicionar nó de produção', ar: 'إضافة عقدة إنتاج' }, minRows: 1, maxRows: 10 },
      ),
...
async function seed(): Promise<void> {
  ...
  const templates: Array<{
    ...
    { name: 'AU-IBAR Monthly Animal Health Report', domain: 'animal-health', schema: buildMonthlyHealthReport(), classification: 'RESTRICTED', kafkaTopic: 'collecte.health.monthly.v1' },
    { name: 'Emergency Disease Reporting', domain: 'animal-health', schema: buildEmergencyDiseaseReport(), classification: 'RESTRICTED', kafkaTopic: 'collecte.health.emergency.v1' },
    { name: 'Mass Vaccination', domain: 'animal-health', schema: buildMassVaccination(), classification: 'RESTRICTED', kafkaTopic: 'collecte.health.vaccination_mass.v1' },
    { name: 'Meat Inspection', domain: 'animal-health', schema: buildMeatInspection(), classification: 'RESTRICTED', kafkaTopic: 'collecte.health.meat_inspection.v1' },
    { name: 'Monthly Abattoir Report', domain: 'animal-health', schema: buildMonthlyAbattoirReport(), classification: 'RESTRICTED', kafkaTopic: 'collecte.health.abattoir_monthly.v1' },
    { name: 'Monthly Vaccination Report', domain: 'animal-health', schema: buildMonthlyVaccinationReport(), classification: 'RESTRICTED', kafkaTopic: 'collecte.health.vaccination_monthly.v1' },
    { name: 'Aquatic Animal Health Event Report', domain: 'animal-health', schema: buildAquaticAnimalHealthReport(), classification: 'RESTRICTED', kafkaTopic: 'collecte.health.aquatic.v1' },

    // ── Livestock Production (7 forms) ──
    { name: 'Animal Breeding and Genomics', domain: 'livestock-prod', schema: buildAnimalBreeding(), classification: 'RESTRICTED', kafkaTopic: 'collecte.livestock.breeding.v1' },
    { name: 'Animal Population (Genetic Diversity)', domain: 'livestock-prod', schema: buildAnimalPopulationGenetic(), classification: 'RESTRICTED', kafkaTopic: 'collecte.livestock.population_genetic.v1' },
    { name: 'Animal Population and Composition', domain: 'livestock-prod', schema: buildAnimalPopulationComposition(), classification: 'RESTRICTED', kafkaTopic: 'collecte.livestock.population.v1' },
    { name: 'Breeder Association', domain: 'livestock-prod', schema: buildBreederAssociation(), classification: 'RESTRICTED', kafkaTopic: 'collecte.livestock.breeder.v1' },
    { name: 'Disaster and Risk Management', domain: 'livestock-prod', schema: buildDisasterRiskManagement(), classification: 'RESTRICTED', kafkaTopic: 'collecte.livestock.disaster.v1' },
    { name: 'Legislation', domain: 'livestock-prod', schema: buildLegislation(), classification: 'RESTRICTED', kafkaTopic: 'collecte.livestock.legislation.v1' },
    { name: 'National Animal Genetic Resources Centre', domain: 'livestock-prod', schema: buildGeneticResourcesCentre(), classification: 'RESTRICTED', kafkaTopic: 'collecte.livestock.genetic_centre.v1' },

    // ── Trade and Marketing (8 forms) ──
    { name: 'Cost of Production', domain: 'trade-sps', schema: buildCostOfProduction(), classification: 'PARTNER', kafkaTopic: 'collecte.trade.cost_production.v1' },
    { name: 'Import and Export', domain: 'trade-sps', schema: buildImportExport(), classification: 'PARTNER', kafkaTopic: 'collecte.trade.import_export.v1' },
    { name: 'Market Demand', domain: 'trade-sps', schema: buildMarketDemand(), classification: 'PARTNER', kafkaTopic: 'collecte.trade.market_demand.v1' },
    { name: 'Market Price', domain: 'trade-sps', schema: buildMarketPrice(), classification: 'PARTNER', kafkaTopic: 'collecte.trade.market_price.v1' },
    { name: 'Market Requirement and Location', domain: 'trade-sps', schema: buildMarketRequirementLocation(), classification: 'PARTNER', kafkaTopic: 'collecte.trade.market_location.v1' },
    { name: 'Quality Standards (Inputs & Services)', domain: 'trade-sps', schema: buildQualityStandardsInputs(), classification: 'PARTNER', kafkaTopic: 'collecte.trade.quality_inputs.v1' },
    { name: 'Quality Standards (Poultry/Hatchery)', domain: 'trade-sps', schema: buildQualityStandardsPoultry(), classification: 'PARTNER', kafkaTopic: 'collecte.trade.quality_poultry.v1' },
    { name: 'Volume and Availability of Transport', domain: 'trade-sps', schema: buildTransport(), classification: 'PARTNER', kafkaTopic: 'collecte.trade.transport.v1' },

# ADR-001: Microservices Architecture for ARIS 4.0
...
ARIS 4.0 is the continental digital infrastructure for the African Union's Inter-African Bureau for Animal Resources (AU-IBAR). The system must serve 55 Member States and 8 Regional Economic Communities (RECs) across 9 distinct business domains: Governance & Capacities, Animal Health & One Health, Production & Pastoralism, Trade Markets & SPS, Fisheries & Aquaculture, Wildlife & Biodiversity, Apiculture & Pollination, Climate & Environment, and Knowledge Management.
...
- **Technology flexibility:** Individual services can adopt domain-specific technologies (e.g., PostGIS for geo-services, OpenSearch for datalake search) without impacting the broader system.
